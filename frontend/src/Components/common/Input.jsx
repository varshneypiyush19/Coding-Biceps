...
const Input = ({
  ...
  return (
    <div className="flex flex-col relative mb-3">
      ...
      <span className="absolute top-[39px] left-3 bg-light p-1 rounded text-blue-400">
        {icon}
      </span>
      <input
        ...
        <>
          {showPassword && (
            <AiOutlineEyeInvisible
              ...
              className="absolute top-[42px] right-3 cursor-pointer text-richgrey-700 text-lg"
            />
          )}
          {!showPassword && (
            <AiOutlineEye
